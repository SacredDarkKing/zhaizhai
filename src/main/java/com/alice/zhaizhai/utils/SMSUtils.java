...
public class SMSUtils {
    ...
    public  void sendSMS(String validateCode, Integer time, String... phoneNumbers) {
        try {
            log.info(secretId + "  " + secretKey.toString() + "  " + phoneNumbers.toString());
            /* 必要步骤：
...
//            String templateId = "449739";
            ...
            String[] templateParamSet = {validateCode, time.toString()};
